...
namespace BethanysPieShop.InventoryManagement
{
    internal class Utilities
    {
        ...
        private static void ShowCreateNewProduct()
        {
            ...
            Console.Write("Enter the description of the new product: ");
        ...
        {
            Console.WriteLine($"Enter the stock threshold (current value: {Product.StockThreshold}). This applies to all products!");
